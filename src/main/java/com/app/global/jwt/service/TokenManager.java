...
public class TokenManager {
    ...
    public JwtTokenDto createJwtTokenDto(Long memberId, Role role) {
        ...
        Date refreshTokenExpireTime = this.createRefreshTokenExpireTime();

        String accessToken = this.createAccessToken(memberId, role, accessTokenExpireTime);
        String refreshToken = this.createRefreshToken(memberId, refreshTokenExpireTime);
